...
export const ASSETS: ThemeAssets = {
  ...
  MaiandraGD: require('../assets/fonts/Maiandra-GD-Regular.ttf'),
  MaiandraGDSemiBold: require('../assets/fonts/Maiandra-GD-SemiBold.ttf'),
  MaiandraGDExtraBold: require('../assets/fonts/Maiandra-GD-ExtraBold.ttf'),

  // backgrounds/logo
  logo: require('../assets/images/logo.png'),
  zyeutissi: require('../assets/images/zyeutissi.png'),
...
export const FONTS: ThemeFonts = {
  ...
  normal: 'MaiandraGD',
  medium: 'MaiandraGDSemiBold',
  semibold: 'MaiandraGDSemiBold',
  bold: 'MaiandraGDExtraBold',
  extrabold: 'MaiandraGDExtraBold',
  black: 'MaiandraGDExtraBold',
};
